...
=item B<ExtraStats> B<false>|B<true>

Enables or disables reporting of additional memory statistics: B<available>, B<anon_pages>, B<mapped> and B<shmem>. Defaults to B<false>.
